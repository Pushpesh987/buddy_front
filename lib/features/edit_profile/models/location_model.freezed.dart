...
abstract class $LocationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'id') String? id, @JsonKey(name: 'location_name') String? locationName});
}
...
class _$LocationModelImpl implements _LocationModel {
  _$LocationModelImpl({@JsonKey(name: 'id') this.id, @JsonKey(name: 'location_name') this.locationName});
...
abstract class _LocationModel implements LocationModel {
  factory _LocationModel(
      ...
      @JsonKey(name: 'location_name') final String? locationName}) = _$LocationModelImpl;
