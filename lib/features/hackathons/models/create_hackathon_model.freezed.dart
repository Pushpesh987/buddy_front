...
CreateHackathonModel _$CreateHackathonModelFromJson(Map<String, dynamic> json) {
  return _CreateHackathonModel.fromJson(json);
}

/// @nodoc
mixin _$CreateHackathonModel {
...
class __$$CreateHackathonModelImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$CreateHackathonModelImpl(
      title: freezed == title
          ? _value.title
          : title // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$CreateHackathonModelImpl implements _CreateHackathonModel {
  ...
  Map<String, dynamic> toJson() {
    return _$$CreateHackathonModelImplToJson(
      this,
    );
  }
}

abstract class _CreateHackathonModel implements CreateHackathonModel {
  factory _CreateHackathonModel(
      {final String? title,
      final String? theme,
      final String? description,
      final String? date,
